...
if __name__ == '__main__':
    ...
    parser.add_argument("--batch_data_dir", type=str, default="", help="")
    ...
    if (args.batch_data_dir == ""):
        ...
        train_examples, eval_examples = get_batched_examples(path_to_json=args.batch_data_dir,
                                          tokenizer=tokenizer,
                                          max_src_len=args.max_src_len,
                                          max_add_len=args.max_add_len,
                                          eval_split = 0.2
    ...
    print(train_hist)
    print(eval_hist)
    # Plot and label the training and validation loss value
